...
export function compileCairoProgram(cairo_program, replace_ids) {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(cairo_program, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
...
export function runTests(cairo_program, allow_warnings, filter, include_ignored, ignored, starknet, run_profiler, gas_disabled, print_resource_usage) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(cairo_program, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(filter, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(run_profiler, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
...
export function compileStarknetContract(starknet_contract, allow_warnings, replace_ids) {
    ...
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(starknet_contract, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_546527d168b1a43b = function(arg0, arg1) {
